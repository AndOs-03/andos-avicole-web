...
<head>
    <title>AndOs Avicole | Achat Produits Entretien</title>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">achat produits</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-blue collapsed-card">
                            ...
                            <!-- corps  -->
                            <div class="card-body">
                                <form id="formAddData" name="formAddData" action="controllers/achat_produit_controller.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group input-group mb-0">
                                                    ...
                                                    <input type="text" class="form-control browser-default"
                                                           name="codeAchat" id="codeAchat" disabled required>
                                                </div>
                                                <div class="mb-3">
                                                    <small id="codeAchatHelp" class="text-danger invisible"></small>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group input-group mb-0">
                                                    ...
                                                    <input type="date" class="form-control browser-default"
                                                           ...
                                                           name="dateAchat" id="dateAchat" required>
                                                </div>
                                                <div class="mb-3">
                                                    <small id="dateAchatHelp" class="text-danger invisible"></small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group input-group mb-0">
                                                    ...
                                                    <input type="text" class="form-control browser-default"
                                                           name="montant" id="montant" value="0" required>
                                                </div>
                                                <div class="mb-3">
                                                    <small id="montantHelp" class="text-danger invisible"></small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group input-group mb-0">
                                                    ...
                                                    <input type="number" class="form-control browser-default"
                                                           name="duree" id="duree" value="1" min="1" required>
                                                </div>
                                                <div class="mb-3">
                                                    <small id="dureeHelp" class="text-danger invisible"></small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-0">
                                                ...
                                                <select class="form-control select2" id="produit" name="produit"
                                                    ...
                                                    for ($j = 0; $j < count($produits); $j++) {
                                                        ?>
                                                        <option
                                                            value="<?= $produits[$j]['libelle'] ?>"><?= $produits['libelle'] ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                <small id="produitHelp" class="text-danger invisible"></small>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <select class="form-control select2" id="produit" name="produit"
                                                    ...
                                                    for ($j = 0; $j < count($fournisseurs); $j++) {
                                                        ?>
                                                        <option
                                                            value="<?= $fournisseurs[$j]['id'] ?>"><?= $fournisseurs['libelle'] ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <select class="form-control select2" id="produit" name="produit"
                                                    ...
                                                    for ($j = 0; $j < count($batiments); $j++) {
                                                        ?>
                                                        <option
                                                            value="<?= $batiments[$j]['id'] ?>"><?= $batiments['libelle'] ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group input-group mb-0">
                                                    ...
                                                    <input type="text" class="form-control browser-default"
                                                           name="stockActuel" id="stockActuel" disabled required>
                                                </div>
                                                <div class="mb-3">
                                                    <small id="stockActuelHelp" class="text-danger invisible"></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="updateModal1" tabindex="-1" aria-labelledby="updateModal1Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formUpdateData" name="formUpdateData" action="controllers/achat_produit_controller.php" method="POST">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Libellé</label>
